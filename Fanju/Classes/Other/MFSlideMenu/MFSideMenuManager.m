...
+ (void) configureWithNavigationController:(UINavigationController *)controller 
    ...
    [[NSNotificationCenter defaultCenter] addObserver:manager 
                                             selector:@selector(flipViewAccordingToStatusBarOrientation:) 
                                               ...
                                               object:nil];
//    below lines make performance like a shit
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer {
    ...
    if([gestureRecognizer isKindOfClass:[UIPanGestureRecognizer class]]) {
        if([gestureRecognizer.view isEqual:self.navigationController.view] ) return YES;//&& self.navigationController.menuState != MFSideMenuStateHidden
