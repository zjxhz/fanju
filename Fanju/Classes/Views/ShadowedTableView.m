...
- (CAGradientLayer *)shadowAsInverse:(BOOL)inverse
{
	...
	id darkColor = (id)[UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha: 
                        inverse ? (SHADOW_INVERSE_HEIGHT / SHADOW_HEIGHT) * 0.5 : 0.5].CGColor;
	id lightColor = (id)[self.backgroundColor colorWithAlphaComponent:0.0].CGColor;
	newShadow.colors =
		[NSArray arrayWithObjects:
			(inverse ? lightColor : darkColor),
